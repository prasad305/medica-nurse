...
function Pharmacy() {
    this.Render = function (Container, Data) {
        ...
        CardBodyPrescriptions.appendChild(new Heading4("Prescriptions", [new Attribute(_AttributeClass, "card-title mb-3 text-center")]));
        ...
        let ButtonSearch = new Button("PrescriptionsSearchButton", "Search", "btn btn-primary btn-rounded w-100 mt-auto",
        ...
        RowSearchResults.appendChild(new Div("PrescriptionsSearchResultsTableWrapper", "col-lg-12"));
...
function PharmacySearchResultsTable() {
    this.Render = function (Container, Data) {
        ...
        DivTablePrescriptions.appendChild(new TableView("TablePharmacySearchResults", "table table-striped", Headers, Data, undefined));
