...
function Login() {
  this.Render = function (Container) {
    ...
    let DivRemember = new Div(undefined, "ml-2 text-center d-flex align-items-center justify-content-center");
    ...
    DivRemember.appendChild(
      new Label(undefined, "&nbsp;Remember Me ", undefined, [
        ...
        new Attribute(_AttributeClass, "ColorBlue mb-0"),
      ])
    );
    ...
    DivContent.appendChild(
      new Button(
        "CmdIAmDoctor",
        "I am a doctor",
        "btn btn-warning btn-rounded w-100 mt-2",
...
function showViewMoreSessionsModal(index) {
  ...
  const tableContent = doctorAndSessions?.sessions.map((session, innerIndex) => {
    ...
    return ` <tr>
                    ...
                    <td class="text-center d-flex" style="border:none!important">
