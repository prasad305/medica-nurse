...
function Pharmacy()
{
    this.Render = function (Container, Data)
    {
        ...
        //Prescription Side Button
        let HeadingViewButton = new Button(undefined, "Button Text", "btn btn-primary btn-rounded", [new Attribute(_AttributeOnClick, "PopupWindowShow()")]);

        CardBodyPrescriptions.appendChild(HeadingPrescriptions);
        CardBodyPrescriptions.appendChild(HeadingViewButton);
...
function ModalWindow(){
    this.Render = function (Container) {
        let ModalFade= new Div(undefined, "modal fade");
        let ModalDialog = new Div(undefined, "modal-dialog modal-dialog-centered");
        let ModalHeader= new Div(undefined, "modal-header");
        let ModelHeading= new Heading5("Popup", undefined);
        //let CloseButton = new Button(undefined, "&times;", "close", [new Attribute(_AttributeOnClick, "ClosePopUp()")]);

        let ModalBody= new Div(undefined, "modal-body");
        let ModalBodyReplace= new Div(undefined, [new Attribute(_AttributeId, "data-wrapper")]);

        let ModalFooter= new Div(undefined, "modal-body");
        let PrintButton = new Button(undefined, "Print", "btn btn-success btn-rounded", [new Attribute(_AttributeOnClick, "")]);
        let CloseButton = new Button(undefined, "Close", "btn btn-danger btn-rounded", [new Attribute(_AttributeOnClick, "")]);

        ModalFooter.appendChild(PrintButton);
        ModalFooter.appendChild(CloseButton);

        ModalBody.appendChild(ModalBodyReplace);
        ModalHeader.appendChild(ModelHeading);
        ModalDialog.appendChild(ModalHeader);
        ModalDialog.appendChild(ModalBody);
        ModalDialog.appendChild(ModalFooter);
        ModalFade.appendChild(ModalDialog);

        //BindView(Container, ModalFade);
    }
}
...
function PopupWindow(){
    this.Render = function (Container, Data)
    {
        ...
        let HeadingPrescriptions = new Heading4("Popup", undefined);
        CardBodyPrescriptions.appendChild(HeadingPrescriptions);

        let FormDateSelect = new Form(undefined);
        let FormRowDateSelect = new Div(undefined, "form-group row mt-3");

        let StartDateDivFormRow = new Div(undefined, "col-sm-6 col-12 mt-2");
        StartDateDivFormRow.appendChild(new Label(undefined, "Start Date", [new Attribute(_AttributeClass, "col-form-label"), new Attribute(_AttributeFor, "StartDate")]));
        StartDateDivFormRow.appendChild(new Textbox("StartDate", "form-control form-control-rounded", [new Attribute(_AttributeType, "date")]));
        FormRowDateSelect.appendChild(StartDateDivFormRow);

        let EndDateDivFormRow = new Div(undefined, "col-sm-6 col-12 mt-2");
        EndDateDivFormRow.appendChild(new Label(undefined, "End Date", [new Attribute(_AttributeClass, "col-form-label"), new Attribute(_AttributeFor, "EndDate")]));
        EndDateDivFormRow.appendChild(new Textbox("EndDate", "form-control form-control-rounded", [new Attribute(_AttributeType, "date")]));
        FormRowDateSelect.appendChild(EndDateDivFormRow);
        FormDateSelect.appendChild(FormRow0PatientSearch);
